...
Fixpoint alternate (l1 l2 : natlist) : natlist :=
  match l1 with
    ...
    | h :: t => match l2 with
      | nil => l1
      | h1 :: t1 => app (h :: h1 :: nil) (alternate t t1)
    end
  end.
...
Theorem bag_count_add : forall (v : nat) (s : bag),
...
Fixpoint beq_natlist (l1 l2 : natlist) : bool :=
  ...
  | h :: t => match l2 with
    | nil => false
    | h1 :: t1 => (beq_nat h h1) && (beq_natlist t t1)
    end
end.
...
(* 已摆烂： *)
Theorem count_sum_distr : forall (n : nat) (s1 : bag),
  count n (sum s1 []) = (count n s1).
Proof.
  intros n s1.
  induction s1 as [| h' t' IHl'].
  - simpl. reflexivity.
  - simpl. reflexivity.
Qed.
...
Theorem rev_pres_beq : forall (l1 l2 : natlist),
  rev l1 = rev l2 -> l1 = l2.
Proof.
  intros l1 l2 H.
